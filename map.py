...
""",
"""Wow, what a grand openning you have found. It's lit quite
...
of a sweaty, nonbathing creater...I suggest you find a way out.
""",
...
""",
"""There is a pill of bodies in a corner. Normally, I wouldn't
...
How did you get this lucky to find:"""
    enemyInfo = None
    #I want to ensure the player has some potions/elixers before they progress
    items = [
...
#This room/location will only have potions/elixers with no enemies
class Aid(object):
...
"""
    ...
    # Loads random potions/elixers to area
    def enter(self):
        self.items = [
            (health.HealthChooser().enter()),
            (health.HealthChooser().enter()),
...
make out the monsterous silhouette. He's got six massive
...
Thanks for playing. Tell your friends.
        print "\n>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>\n"
If you enjoyed this game, consider donating:
Go to: slbateman.pythonanywhere.com/donate"""
        print "\n>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>\n"
